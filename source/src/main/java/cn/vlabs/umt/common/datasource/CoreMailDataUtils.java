...
public class CoreMailDataUtils {
	public CoreMailDataUtils(Config config){
		...
		ds.setUsername(config.getStringProp("database.coremail.username", null));
		ds.setPassword(config.getStringProp("database.coremail.password", null));
		ds.setDriverClassName(config.getStringProp("database.driver", null));
		ds.setUrl(config.getStringProp("database.coremail.conn-url", null));
	...
	private static final Logger log=Logger.getLogger(CoreMailDataUtils.class);
}
