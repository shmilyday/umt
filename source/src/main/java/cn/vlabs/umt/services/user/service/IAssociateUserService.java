 ...
 * @since 2013-3-12
 */
public interface IAssociateUserService {
	static final String BEAN_ID="associateUserService";
	/**
	 * 增加关联账户
	 * @param uid
	 ...
	 * @param appList 应用列表 AssociateUser.APP_XXX逗号分隔
	 */
	void updateAssociateUser(int uid,int associateUid,String appList);
	 ...
	 * @return 
	 * */
	boolean isAssociated(String loginName);
}