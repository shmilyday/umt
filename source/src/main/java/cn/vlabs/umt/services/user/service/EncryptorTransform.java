...
public class EncryptorTransform implements ITransform {
	...
	private static final Logger LOGGER=Logger.getLogger(EncryptorTransform.class);
    private String algorithm;
    public void setConfig(Config config)
    {
    	algorithm = config.getStringProp("PASSWORDS_ENCRYPTION_ALGORITHM", Digester.DIGEST_ALGORITHM);
    }
	...
	private String transform(String clearTextPwd, String currentEncPwd) throws PwdEncryptorException
	{
		///在umt中约定，对于空密码，不进行摘要
	...
	private static String encodePassword(String algorithm, String clearTextPwd, byte[] saltBytes)
