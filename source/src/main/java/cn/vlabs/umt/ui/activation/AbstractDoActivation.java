...
public abstract class AbstractDoActivation {
	...
	/**错误页面*/
	public abstract String toError();
	/**
	 * 成功页面
	 * */
	public abstract String toSuccess();
	 ...
	 * @param response
	 */
	public abstract String hasLoginAndIsSelf();
	 ...
	 * @param response
	 * */
	public abstract String hasLoginAndNotSelf();
	 ...
	 * @param response
	 * */
	public abstract String notLogin();
	protected String getMessageUrl(String message) {
		String url="/show.do?act=showMessage";
