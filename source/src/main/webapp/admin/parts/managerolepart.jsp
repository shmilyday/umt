		...
		<form action="manageRole.do" method="post" name="memberform">
			...
			<table class="table table-hover" border="0" width="100%">
				<tr>
					...
					<th>
						<fmt:message key="privilege.list.username"/>
					</th>
					<th>
						<fmt:message key="privilege.list.truename"/>
					</th>
					<th>
						<fmt:message key="privilege.list.email"/>
					</th>
				</tr>
			...
			<div class="buttons">
				<input type="button" id="btnRemove" value="<fmt:message key="privilege.btn.remove"/>" />
				<input type="button" id="btnAdd" value="<fmt:message key="privilege.btn.add"/>" />
			</div>
		</form>
	</div>
</div>
	...
	<form name="addform" method="post" action="manageRole.do">
		...
		<table>
			<tr>
				...
				<td>
					<input type="text" id="query" name="username" />
				</td>
			</tr>
		</table>
	</form>
