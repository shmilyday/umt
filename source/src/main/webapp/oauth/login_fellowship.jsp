...
<head>
	...
	<f:css href="${context }/css/embed_fellowship.css"/>
...
<body>
	<div class="MainR">
		...
		<div id="logArea">
	        ...
	        <form id="loginForm" action="authorize?${user_oauth_request.url}" method="post" class="cst-oauth"  target="_parent">
	            ...
	            <div class="inptr">
	                <label for="userName" style="margin-top:-6px; *margin-top:-1px;">
	                
	                <span style="float: left;padding-right: 10px;text-align: right;width: 69px;">User ID</span>
	                <div class="input-prepend">   
								<span class="add-on" id="user"> </span>
	                <input tabindex=1 type="text" value="${!empty userName?userName:autoFill }" class="input" name="userName" id="userName" placeholder="xxx@gmail.com">
	            	</div>
	            ...
	            <div class="inptr">
	                <label for="password">
	                <span style="float: left;padding-right: 10px;text-align: right;width: 69px;" >Password</span>     
	                ...
	                <input tabindex=2 type="password" id="password" placeholder="password" name="password" value="${password }" class="input">
	            	</div>
	            	</label>
	            </div>
	            ...
	            <div class="inptr indent">
                	<label class="for">    
                		<a style="margin-left:80px" tabindex=-1 target="_blank" href="${context }/findPsw.do?act=stepOne">Forgotten Password</a>
                	</label>
	            </div>
	            <!-- 
	            <div style="margin-bottom: 20px;margin-top:-25px" class="inptr indent">
	             ...
	             -->
	            <div class="inptr indent">
                    <a tabindex=3 style="margin-left:80px" id="submitButton" class="btn btn-primary"><fmt:message key="login.title"/></a> 
                    <input tabindex=4 type="hidden" id="pcVisitors" value="http://www.fellowship.cas.cn/dms/register.jspx"/>
                    <a class="btn btn-success" id="visitorHref" href="http://www.fellowship.cas.cn/dms/register.jspx" target="_blank">Register</a>
	            </div>
	...
	if(showValidCode=="true"||showValidCode==true){
		...
		oauthUrl=oauthUrl.replace("theme=fellowship","theme=full");
