...
<body class="embed" style="background:transparent">
	...
	<div class="cst-container embed">
		...
		<form id="loginForm" action="authorize?${user_oauth_request.url}" method="post" class="cst-oauth"  target="_parent" style="padding-top:40px;">
			...
			<div class="cst-controls">
				...
				<div class="controls">
				 <div class="input-prepend">
					<span class="add-on preparePopover" id="user"  data-html='true' data-animation='false' data-trigger="click" data-placement="top" 
								data-content="<a tabindex='-1' href='${context }/what-is-cstnet-passport.jsp?locale=${user_locale}' target='blank' ><fmt:message key='common.duckling.QA'/></a>">
						<a tabindex=-1 target="_blank" href="${context }/what-is-cstnet-passport.jsp?locale=${user_locale}" style="display:inline-block; width:20px; height:20px;"></a>
					 </span>
