...
public class UserAgentUtil {  
    ...
    public static UserAgent getUserAgent(String userAgent) {  
        ...
        if (userAgent.contains("Windows")) {//主流应用靠前  
             ...
             */  
        	 if (userAgent.contains("Windows NT 6.4")) {//Windows 8  
                 return judgeBrowser(userAgent, "Windows", "10" , null);//判断浏览器  
             }else if (userAgent.contains("Windows NT 6.2")||userAgent.contains("Windows NT 6.3")) {//Windows 8  
            ...
            if (userAgent.contains("iPod")||userAgent.contains("iPad")||userAgent.contains("iPhone")) {  
                return judgeBrowser(userAgent, "IOS", null , null);//判断浏览器  
            }else{
            	 return judgeBrowser(userAgent, "MacOsX", null , null);//判断浏览器  
            }
