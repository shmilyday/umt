 ...
 * limitations under the License.
 */
package cn.vlabs.umt.common.digest;
...
public class Md5CryptDigest {
	...
	public static final Charset UTF_8 = Charset.forName(Constant.DEFAULT_CHARSET);
    ...
    public static String apr1Crypt(final byte[] keyBytes, String salt) {
        ...
        try {
			return Md5CryptDigest.md5Crypt(keyBytes, salt, APR1_PREFIX);
		} catch (NoSuchAlgorithmException e) {
			// TODO Auto-generated catch block
			return null;
		}
    }
    public static String md5Crpt(String password){
		return (md5Crypt(password.getBytes(),"$1$"+B64.getRandomSalt(8)));
	}
