...
<body class="login">
	...
	<div class="container login gray">
		...
		<form id="loginForm"
			action="<umt:url value="/primary/activation.do?act=validPasswordPrimary"/>"
			method="post">
			<table class="form_table">
				<tr>
					<th>主要电子邮件地址：</th>
					<td>${_primaryEmail} <span id="loginName_error_place"
						class="error"> <c:if test="${!empty loginName_error }">
				...
				<tr>
					...
					<td><input type="password" name="password" id="password" /> <span
						id="password_error_place" class="error"> <c:if
				...
				<tr>
					<th></th>
					<td><input type="hidden" value="${_primaryEmail }"
						name="loginName" />
						<button class="btn long btn-primary" type="submit">确定</button></td>
				</tr>
			</table>
