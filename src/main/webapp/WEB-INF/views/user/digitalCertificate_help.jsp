	...
	<body class="login">
		...
		<div class="container login gray">
			<ul class="sub-nav">
				...
				<li class="active" id="accountBind"><a href="<umt:url value="/user/digitalCertificate.do?act=help"/>"><fmt:message key='digitialManage.title.help' /></a></li>
				<div class="clear"/>
			</ul>
			<div class="sub-content" id="accountManageShow">
				<h4 class="sub-title">帮助文档列表</h4>
