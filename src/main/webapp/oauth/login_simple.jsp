	              	...
	              	<div class="controls small-font">
	              		<p><fmt:message key='common.login.userOtherName'/>  
							...
							<c:if test="${!empty thirdPartyList['geo'] }">
								<a  tabindex=8 href="<umt:url value="/thirdParty/login?type=geo"/>"><img src="<umt:url value="/images/login/cas_geo.png"/>" alt="<fmt:message key='oauth.3pt.geodata.login'/>" title="<fmt:message key='oauth.3pt.geodata.login'/>" /></a>
							</c:if>
